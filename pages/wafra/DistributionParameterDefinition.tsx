...
const DistributionParameterDefinitionPage = () => {
    let useScreen = Nar.Screen.useScreen();
    let TableData2 = Nar.Controller.useDataTable();
    return <> 
        <useScreen.View screencode="ValEnt" screenname="Dağıtım Parametre Tanım Ekranı" onSaveClick={(e) => {
            e.setBlocking(true);
            setTimeout(() => {
                e.setBlocking(false);
            }, 5000);
            ...
            <TableData2.View
                ...
                header="  Ekran program dahilinde tanımlanan tüm parametrelerin listeleneceği şekilde açılacaktır.
                Yeni / Güncelle düğmesi listeden herhangi bir kayıt seçilmediğinde Yeni olarak, bir kayıt seçildiğinde ise Güncelle olarak gösterilecektir. "
                selectableRows
...
export default DistributionParameterDefinitionPage